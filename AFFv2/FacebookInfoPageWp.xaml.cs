...
namespace AFFv2
{
    public partial class FacebookInfoPageWp : PhoneApplicationPage
        {
        private string _accessToken;
        private string _userId;

        public FacebookInfoPageWp()
        {
        ...
        {
            txtMessage.Text = WinphoneApps.MYAzure[WinphoneApps.PublicId].appname + " application is awesome" + " try it! Download it! " + " #AcademicAppFactory" + " #EgyptAppFactory " + " #Windows8 " + WinphoneApps.MYAzure[WinphoneApps.PublicId].applink;
...
LoadPageData();
        ...
        private void DeleteLastMessage_Click(object sender, RoutedEventArgs e)
        {
            if (txtMessage.Text == "")
            {
                ...
                MessageBox.Show("write your post");
            }
            else
            {
                var fb = new FacebookClient(_accessToken);
