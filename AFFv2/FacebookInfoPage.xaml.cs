...
namespace AFFv2
{
    public partial class FacebookInfoPage : PhoneApplicationPage
    {
        ...
        {
            string id = NavigationContext.QueryString["access_token"];
            DataFill df = new DataFill();
            switch (id)
            {
                case "0": txtMessage.Text = "مترو القاهرة" + " application is awesome" + " try it! Download it! " + " #AcademicAppFactory" + " #EgyptAppFactory " + " #Windows8 " + "http://apps.microsoft.com/windows/en-us/app/52a6452e-44ec-4748-bdcc-22440bbaa46c";
                    break;


            }

            txtMessage.Text = Page1.items[Page1.PublicId].appname + " application is awesome" + " try it! Download it! " + " #AcademicAppFactory" + " #EgyptAppFactory " + " #Windows8 " + Page1.items[Page1.PublicId].applink;
